...
func easyjson56de76c1DecodeGithubComPatradenYaPracticumGoShortlyInternalAppDto(in *jlexer.Lexer, out *URLPairBatch) {
...
func easyjson56de76c1EncodeGithubComPatradenYaPracticumGoShortlyInternalAppDto(out *jwriter.Writer, in URLPairBatch) {
...
func easyjson56de76c1DecodeGithubComPatradenYaPracticumGoShortlyInternalAppDto1(in *jlexer.Lexer, out *URLPair) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson56de76c1EncodeGithubComPatradenYaPracticumGoShortlyInternalAppDto1(out *jwriter.Writer, in URLPair) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func easyjson56de76c1DecodeGithubComPatradenYaPracticumGoShortlyInternalAppDto2(in *jlexer.Lexer, out *SlugBatch) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		in.Skip()
		*out = nil
...
func easyjson56de76c1EncodeGithubComPatradenYaPracticumGoShortlyInternalAppDto2(out *jwriter.Writer, in SlugBatch) {
	if in == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
		out.RawString("null")
	} else {
		out.RawByte('[')
...
func easyjson56de76c1DecodeGithubComPatradenYaPracticumGoShortlyInternalAppDto3(in *jlexer.Lexer, out *ShortenedURLResponse) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson56de76c1EncodeGithubComPatradenYaPracticumGoShortlyInternalAppDto3(out *jwriter.Writer, in ShortenedURLResponse) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func easyjson56de76c1DecodeGithubComPatradenYaPracticumGoShortlyInternalAppDto4(in *jlexer.Lexer, out *ShortenURLRequest) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson56de76c1EncodeGithubComPatradenYaPracticumGoShortlyInternalAppDto4(out *jwriter.Writer, in ShortenURLRequest) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func easyjson56de76c1DecodeGithubComPatradenYaPracticumGoShortlyInternalAppDto5(in *jlexer.Lexer, out *OriginalURLBatch) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		in.Skip()
		*out = nil
...
func easyjson56de76c1EncodeGithubComPatradenYaPracticumGoShortlyInternalAppDto5(out *jwriter.Writer, in OriginalURLBatch) {
	if in == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
		out.RawString("null")
	} else {
		out.RawByte('[')
...
func easyjson56de76c1DecodeGithubComPatradenYaPracticumGoShortlyInternalAppDto6(in *jlexer.Lexer, out *CorrelatedSlug) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson56de76c1EncodeGithubComPatradenYaPracticumGoShortlyInternalAppDto6(out *jwriter.Writer, in CorrelatedSlug) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func easyjson56de76c1DecodeGithubComPatradenYaPracticumGoShortlyInternalAppDto7(in *jlexer.Lexer, out *CorrelatedOriginalURL) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson56de76c1EncodeGithubComPatradenYaPracticumGoShortlyInternalAppDto7(out *jwriter.Writer, in CorrelatedOriginalURL) {
	out.RawByte('{')
	first := true
	_ = first
	{
